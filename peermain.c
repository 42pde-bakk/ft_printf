...
int	main(void)
{
	...
	ft_printf("<- %i \n", ft_printf("%+08.6d , |%+8.6d, |%+07d, |%+7d, |%+-7d, |%.-7d, |%*.*d", 32, 32, 32, 32, -32, -32, -13, -8, -32));
	printf("<- %i \n\n", printf("%+08.6d , |%+8.6d, |%+07d, |%+7d, |%+-7d, |%.-7d, |%*.*d", 32, 32, 32, 32, -32, -32, -13, -8, -32));
	ft_printf("\033[0m");
	...
	ft_printf("<- %i \n", ft_printf("%f, %-10.2f, %.f", d1, d1, d1));
	printf("<- %i \n\n", printf("%f, %-10.2f, %.f", d1, d1, d1));
	ft_printf("\033[0;32m");
